...
export const paths = {
  ...
  dashboard: {
    ...
    // },
    chapterLeader: {
      root: `${ROOTS.DASHBOARD}/chapter-leader`,
      new: `${ROOTS.DASHBOARD}/chapter-leader/new`,
      list: `${ROOTS.DASHBOARD}/chapter-leader/list`,
      cards: `${ROOTS.DASHBOARD}/chapter-leader/cards`,
      profile: `${ROOTS.DASHBOARD}/chapter-leader/profile`,
      account: `${ROOTS.DASHBOARD}/chapter-leader/account`,
      edit: (id: string) => `${ROOTS.DASHBOARD}/chapter-leader/${id}/edit`,
      demo: {
